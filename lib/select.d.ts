export declare class Select {
    ...
    selectedIndex: any;
    selectedDisplay: any;
    constructor(Root: HTMLElement, Name: string, Index: string, Display: string, PreselectIndex?: string, Placeholder?: string, Data?: Array<any>, Id?: string, Class?: string, Style?: string);
    private init;
    private create;
    private option;
    private placeholder;
