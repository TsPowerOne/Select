    ...
    function Select(Root, Name, Index, Display, PreselectIndex, Placeholder, Group, Data, Id, Class, Style) {
        ...
        this.init = function () {
            _this.node.addEventListener("change", function (event) {
                ...
                var selezionato = _this.Data.filter(function (e) { return e[_this.Index] == _this.selectedIndex; });
                _this.changed.next({ index: _this.selectedIndex, display: _this.selectedDisplay, rowData: selezionato[0] });
            });
        };
        ...
        this.selItem = function (value) {
            ...
            option.setAttribute("selected", '');
            if (value != "unselect") {
                var selezionato = _this.Data.filter(function (e) { return e[_this.Index] == option.value; });
                if (selezionato) {
                    _this.selectedIndex = selezionato[0][_this.Index];
                    _this.selectedDisplay = selezionato[0][_this.Display];
                    _this.selected.next({ index: _this.selectedIndex, display: _this.selectedDisplay, rowData: selezionato[0] });
                    _this.changed.next({ index: _this.selectedIndex, display: _this.selectedDisplay, rowData: selezionato[0] });
                }
            }
        };
        ...
        this.getSelected = function () {
            var selezionato = _this.Data.filter(function (e) { return e[_this.Index] == _this.selectedIndex; });
            return { index: _this.selectedIndex, display: _this.selectedDisplay, rowData: selezionato[0] };
        };
