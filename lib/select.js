...
var Select = /** @class */ (function () {
    function Select(Root, Name, Index, Display, PreselectIndex, Placeholder, Data, Id, Class, Style) {
        ...
        this.create = function () {
            ...
            var template = "<select name=\"" + _this.Name + "\" " + ((id) ? id : "") + " " + ((classe) ? classe : "") + " " + ((stile) ? stile : "") + " >\n                        </select>";
